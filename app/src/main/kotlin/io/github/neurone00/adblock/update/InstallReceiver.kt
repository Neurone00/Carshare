...
import io.github.neurone00.adblock.AdBlockApp
...
class InstallReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (status) {
            PackageInstaller.STATUS_PENDING_USER_ACTION -> {
                ...
                if (foreground) {
                    try { context.startActivity(confirm); return } catch (_: Exception) {}
                }
                ...
                val n = Notification.Builder(context, AdBlockApp.CHANNEL_UPDATES)
                    ...
                    .setAutoCancel(true)
                    .build()
                context.getSystemService(NotificationManager::class.java)?.notify(2, n)
            }
    ...
    companion object {
        const val ACTION = "io.github.neurone00.adblock.INSTALL_STATUS"
